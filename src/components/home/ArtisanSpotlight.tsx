...
export function ArtisanSpotlight() {
  const [featuredArtisans, setFeaturedArtisans] = useState(SAMPLE_ARTISANS.filter(artisan => artisan.featured));
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {featuredArtisans.length > 0 ? (
          ...
          <div className="text-center py-10">
            <p className="text-muted-foreground">No featured artisans available.</p>
          </div>
        )}
