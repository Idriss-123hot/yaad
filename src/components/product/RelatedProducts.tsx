...
export const RelatedProducts = ({
        ...
        const {
          ...
          error: additionalError
            ...
            *,
            ...
            category:categories(*),
            subcategory:subcategories(*)
          `).not('id', 'in', `(${excludeIds.join(',')})`).order('featured', {
          ascending: false
  ...
  return <section className="py-12 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <h2 className="font-serif text-2xl font-bold mb-8">Vous pourriez aussi aimer</h2>
